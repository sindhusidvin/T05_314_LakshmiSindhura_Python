...
Smallest individual unit in python program where all statements and instructions in program are built with tokens.
...
2.Explicit typecasting:
 It converts the variable datatype into certain datatype in order of the operation required.Here user involvement will be there.'''